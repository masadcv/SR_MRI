...
class IDN(nn.Module):
    def __init__(self, scale, image_features=16, fblock_num_features=16, num_features=64, d=16, s=1):
        super(IDN, self).__init__()
        self.scale = scale

        self.upsampling_layer = torch.nn.Upsample(scale_factor=scale, mode='bicubic', align_corners=False)
